...
class OrderController extends Controller
{
    ...
    {
        $order = $this->model->with(['hasItems', 'hasStatus', 'hasStatusLogs.hasToStatus', 'hasStatusLogs.hasFromStatus', 'hasCustomer', 'hasLaundry'])->findOrFail($id);
    ...
    {
        $order = $this->model->with(['hasItems', 'hasStatus', 'hasCustomer', 'hasLaundry'])->findOrFail($id);
