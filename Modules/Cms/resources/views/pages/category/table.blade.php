<?php /** @var Modules\Cms\Models\Category $table */ ?>
                ...
                <x-table-mobile-list>
                    ...
                    <x-table-mobile-item :id="$table->field_primary">
                        ...
                        <div class="mt-2 space-y-1.5">
                            ...
                            <div class="flex justify-between items-center gap-2">
                                <span class="text-xs text-on-surface-variant">Parent</span>
                                <span class="text-sm font-medium text-right">{{ $table->has_parent->name ?? '-' }}</span>
                            </div>
                            <div class="flex justify-between items-center gap-2">
